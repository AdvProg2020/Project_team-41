...
public class OffButtonController {
    ...
    private void editCategory() throws IOException {
        editOffController.globalManageCategoryMenu = (AnchorPane) categoryNameAnchorPane.getParent().getParent().getParent().getParent().getParent();
        editOffController.globalCategoryName = categoryNameTextField.getText();
        VBox vBox = (VBox) gridPane.getParent().getParent().getParent();
    ...
    private int getIndexOfCategory(){
        ...
        editOffController.globalManageCategoryMenu = (AnchorPane) categoryNameAnchorPane.getParent().getParent().getParent().getParent().getParent();
        editOffController.globalCategoryName = categoryName;
        VBox vBox = (VBox) gridPane.getParent().getParent().getParent();
    ...
    public void editOffClicked(MouseEvent mouseEvent) {
    }
