...
public enum MessageType {
    ...
    LOGIN(ClassTypes.LOGIN_REGISTER),REGISTER(ClassTypes.LOGIN_REGISTER),CHECK_MANAGER(ClassTypes.LOGIN_REGISTER),
    ...
    public enum  ClassTypes {
        USER_SECTION,MANAGER_SECTION,SELLER_SECTION,BUYER_SECTION,LOGIN_REGISTER,OFFS,ALL_PRODUCTS,PRODUCT
    }
}
