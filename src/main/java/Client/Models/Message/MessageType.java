...
public enum MessageType {
    SUCCESSFUL(null),
    GET_PERSONAL_INFO(ClassTypes.USER_SECTION),EDIT(ClassTypes.USER_SECTION),GET_MANAGER_ACCOUNT_ID(ClassTypes.USER_SECTION), GET_WAGE(ClassTypes.USER_SECTION),
    ...
    ADD_BID(ClassTypes.BID),GET_ALL_BIDS(ClassTypes.BID);
