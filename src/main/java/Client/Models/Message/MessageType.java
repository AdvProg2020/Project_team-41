...
public enum MessageType {
    SUCCESSFUL(null),
    GET_PERSONAL_INFO(ClassTypes.USER_SECTION),EDIT(ClassTypes.USER_SECTION),GET_MANAGER_ACCOUNT_ID(ClassTypes.USER_SECTION), GET_WAGE(ClassTypes.USER_SECTION), GET_LOGGED_IN_PERSON(ClassTypes.USER_SECTION), INCREASE_CREDIT(ClassTypes.USER_SECTION), GET_MINIMUM_CREDIT(ClassTypes.USER_SECTION),
    ...
    ADD_COMMENT(ClassTypes.PRODUCT),AMOUNT_OF_DISCOUNT(ClassTypes.PRODUCT),ADD_PRODUCT_TO_CART(ClassTypes.PRODUCT),INCREASE_PRODUCT_VIEW_BY_ONE(ClassTypes.PRODUCT),ADD_SCORE(ClassTypes.PRODUCT),
